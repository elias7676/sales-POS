...
$pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false); // remove default header/footer 
$pdf->setPrintHeader(false); $pdf->setPrintFooter(false); // set margins 
$pdf->SetMargins(0, 0, 0, true); // set auto page breaks false 
$pdf->SetAutoPageBreak(false, 0); // add a page 
$pdf->AddPage('P', 'A4'); // Display image on full page 
$pdf->Image('bg.png', 50, 990, 500, '', 'PNG', '', '', false, 300, '', false, false, 60, true, false, true); //Close and output PDF document
// $background_text = str_repeat('TCPDF test PNG Alpha Channel ', 50);
// $pdf->MultiCell(0, 5, $background_text, 0, 'J', 0, 2, '', '', true, 0, false)
//$pdf->Image('bg.png', 50, 50, 100, '', 'PNG', 'http://www.tcpdf.org', '', false, 300);
// ---------------------------------------------------------

$block1 = <<<EOF
   <body style=" background-image: url("bg.png");">
	<table style="background-image:url("bg.png");">
		...
		<tr>
			...
			<td style="background-image:url("bg.png"); width:140px">
...
?>
<style type="text/css">
	#watermark {background: url(bg.png); }
</style>