...
function chan(input){
	...
	var meth = $(input).val();
$("#listPaymentMethod").val("For "+$("#newDue").val()+" // "+$("#newTransactionCode").val());
...
$("#newPaymentMethod").change(function(){
	...
	if(method == "cash"){
		...
		$(this).parent().parent().parent().children(".paymentMethodBoxes").html(
			...
			'<input type="text"  class="form-control" id="newTransactionCode" placeholder="Cheque No"  required>'+
			 ...
			 '<div class="col-xs-4"  style="padding-left:0px">'+
			 	...
			 	'<div class="input-group">'+
			 		...
			 		'<i class="input-group-addon">FOR</i> <input type="date" id="newDue" class="form-control" placeholder="Due Date" onchange="chan(this)"  required>'+
...
PRINT SALE BUTTON
=============================================*/
$(".tables").on("click", ".btnPrint", function(){

	var idSale = $(this).attr("idSale");

	window.location = "/fol/views/modules/bill-a4.php?s=up&idSale="+idSale;
